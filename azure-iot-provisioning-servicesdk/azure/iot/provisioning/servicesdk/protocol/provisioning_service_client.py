...
class ProvisioningServiceClient(SDKClient):
    ...
    def query_individual_enrollments(
            self, query_specification, x_ms_max_item_count=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of IndividualEnrollment
        :rtype:
         ~protocol.models.IndividualEnrollmentPaged[~protocol.models.IndividualEnrollment]
        :raises:
         :class:`ProvisioningServiceErrorDetailsException<protocol.models.ProvisioningServiceErrorDetailsException>`
        """
        ...
        deserialized = models.IndividualEnrollmentPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.IndividualEnrollmentPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
